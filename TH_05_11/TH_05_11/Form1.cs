...
namespace TH_05_11
{
    public partial class Form1 : Form
    {
        ...
        {
            customers.Add(new Customer(1, "Van Dang Hieu", "0123456789", "Co Nhue 2"));
            customers.Add(new Customer(2, "Nguyen Van Duc", "098765431", "Hoang Quoc Viet"));
            services.Add(new Service(1, "Cắt tóc", 200000));
            services.Add(new Service(2, "Gội đầu", 150000));
            services.Add(new Service(3, "Nhuộm tóc", 100000));
        }
